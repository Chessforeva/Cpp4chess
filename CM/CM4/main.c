...
static char *cfgtxt[] = {
 (char *)";",
 (char *)"; Configuration file for the chess checkmate generator.",
 (char *)"; Freeware by Chessforeva, feb.2022, gcc version, uint64 based",
 (char *)";",
 (char *)"; Can find checmates M1,M2 (fast), M3(so,so),M4(slow), M5(got one)...",
 ...
 (char *)"; MagicsNumbers move generator is fast.",
 (char *)"; And it is better to compile on 64bit devices, not Win32. Busy now.",
 (char *)"; Patterns included for anniversary puzzles.",
 (char *)";",
 (char *)"; Parameters:",
 (char *)"",
 (char *)"",
 (char *)"; Moves to mate M1=1, M2=2, M3=3, M4=4...",
 (char *)"CDEPTH=1",
 (char *)"",
 ...
 (char *)"RANDOMIZER=1",
 (char *)"",
 (char *)"; Maximum pieces on board (- faster), approx.",
 (char *)"PcMAX=8",
 (char *)"",
 (char *)"; Pieces n-times more to mate the king (+ faster), approx.",
 ...
 (char *)"HcMAX=6",
 (char *)"",
 (char *)"; Pattern of board (1=on,0-off)",
 (char *)"PATTERN=0",
 (char *)"% ++++++++",
 (char *)"% ++OOOO++",
 (char *)"% ++O+++++",
...
void ReadConfig()
{
    ...
    if(cfg==NULL) printf("Can not read configuration file!\n");
        ...
        for(;!feof(cfg);)
            {
            fgets(buff, 1000, cfg);
            if(buff[0]=='%' && strlen(buff)<40) addPattern(buff);
            ...
            if(a>=0)
                {
                 ...
                 if(startswith_slow(buff,(char *)"PATTERN")) PATTERN=val;
                }
            }
        fclose(cfg);
        }
