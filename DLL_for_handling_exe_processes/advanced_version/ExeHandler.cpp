//
// ExeHandler - Win32 DLL library component to start sub-process,
//  control stdin/stdout streams continuously.
// by Chessforeva, 2014, gcc version
...
void printf2 (std::string s)
{
    MessageBox(NULL, &s[0], TEXT("ExeHandler message"), MB_OK);
};
...
// __gxx_personality_v0 entry point declaration
extern "C" _Unwind_Reason_Code  __declspec(dllexport) __gxx_personality_v0
